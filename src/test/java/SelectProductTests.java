...
public class SelectProductTests {
    ...
    @Test
    void selectThePeanutButterTest() {
        open("https://duckduckgo.com/");
        
        $("input[name='q']").setValue("maslotom").pressEnter();

        // select the found website
        $("div[data-domain='maslotom.com']").click();

        //scroll to "pasta" and click it
        $(".child-cat-list a[href='/basic']").scrollTo().click();
        // move to element and
       $x("//a[@href='/product/arahisova-pasta-klasichna-180-sklo']/span[contains(text(),'паста')]").click();
        // $(by("href", "/product/arahisova-pasta-klasichna-180-sklo")).$(byText("паста")).click();
